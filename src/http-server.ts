      ...
      switch (name) {
        ...
        case "pt_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "AdC (Autoridade da Concorrencia — Portuguese Competition Authority) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the Lei da Concorrencia (Law No. 19/2012).",
